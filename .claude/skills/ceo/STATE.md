...
- [ ] Fix autoplay-return bug (Meka's only hard defect — see memory `beta-feedback-meka`)
- [ ] Meka simplicity pass (survey slimming, Reveal self-pacing, bigger deck cards + scrubbing, Polish reframe controls — triage which are Phase 0 vs parked)
- [ ] Device-test Style Templates v2 end-to-end (code-complete, ZERO device testing)
- [ ] Device-test voiceover M3 end-to-end (unblocked since model-ID bump, still untested)
- [ ] Ship Cut Card + Breakdown Sheet redesign (decided 2026-07-13, not built)
